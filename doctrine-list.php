...
{
frmobj.action = "doctrine-del.php";
...
<div class="heading">
<div class="heading-left">View Doctrine</div>
<div class="heading-right"><a href="doctrine-add.php" class="button1">Add Doctrine</a></div>
<div class="clr"></div>
</div>
...
<td width="9%">Title</td>
<td width="36%">Author</td>
<td width="36%">Posted_on</td>
<td width="8%">Pdf</td>
...
$sql= "SELECT * FROM  doctrine ORDER BY id desc";
...
<?php } ?></td>
<td align="center"><a href="doctrine-add.php?id=<?php echo urlencode(base64_encode($id)); ?>"><img src="images/edit.png" alt=""></a></td>
