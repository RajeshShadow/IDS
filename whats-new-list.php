...
{
frmobj.action = "whats-new-del.php";
...
<div class="heading">
<div class="heading-left">View whats-new </div>
<div class="heading-right"><a href="whats-new-add.php" class="button1">Add whats-new </a></div>
<div class="clr"></div>
</div>
...
$sql= "SELECT * FROM  whats_new ORDER BY id desc";
...
<?php } ?></td>
<td align="center"><a href="whats-new-add.php?id=<?php echo urlencode(base64_encode($id)); ?>"><img src="images/edit.png" alt=""></a></td>
