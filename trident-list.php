...
<div class="heading">
<div class="heading-left">View Trident</div>
<div class="heading-right"><a href="trident-add.php" class="button1">Add Trident</a></div>
<div class="clr"></div>
</div>
...
$sql= "SELECT * FROM  trident ORDER BY id desc";
...
<?php } ?></td>
<td align="center"><a href="trident-add.php?id=<?php echo urlencode(base64_encode($id)); ?>"><img src="images/edit.png" alt=""></a></td>
