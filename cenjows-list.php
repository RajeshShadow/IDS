...
<div class="heading">
<div class="heading-left">View Cenjows Paper</div>
<div class="heading-right"><a href="cenjows-add.php" class="button1">Add Cenjows Paper</a></div>
<div class="clr"></div>
</div>
...
$sql= "SELECT * FROM  cenjows ORDER BY id desc";
...
<?php } ?></td>
<td align="center"><a href="cenjows-add.php?id=<?php echo urlencode(base64_encode($id)); ?>"><img src="images/edit.png" alt=""></a></td>
