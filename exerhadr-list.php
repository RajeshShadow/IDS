...
frmobj.action = "exerhadr-del.php";
...
<div class="heading-left">View Hadr/exercises</div>

<div class="heading-right"><a href="exerhadr-add.php" class="button1">Add Hadr/exercises</a></div>
...
<td width="8%">In Gallery</td>

<td width="8%">In Hadr Exer</td>

<td width="8%">Add Images</td>
...
$sql= "SELECT * from hadr_exer   ORDER BY id desc";
...
<td><img src="upload_images/leadership/<?php echo $data['image']; ?>" alt=""></td>
<?php if($data['gal']==1){
    $yes='yes';
}
    else{
...
<td><a href="hadr-gallery-list.php?cat_id=<?php echo urlencode(base64_encode($data['id'])); ?>"><img src="images/add.png" alt=""></a></td>
...
<td align="center"><a href="exerhadr-edit.php?id=<?php echo urlencode(base64_encode($id)); ?>"><img src="images/edit.png" alt=""></a></td>
