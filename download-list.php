...
{
frmobj.action = "download-del.php";
...
<div class="heading">
<div class="heading-left">View Download </div>
<div class="heading-right"><a href="download-add.php" class="button1">Add Download </a></div>
<div class="clr"></div>
</div>
...
<?php } ?></td>
<td align="center"><a href="download-add.php?id=<?php echo urlencode(base64_encode($id)); ?>"><img src="images/edit.png" alt=""></a></td>
