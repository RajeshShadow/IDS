...
<div class="heading-left">View Tender</div>

<div class="heading-right"><a href="tender-add.php" class="button1">Add Tender</a></div>
...
<td width="36%">Tender Document</td>
...
<td align="center"><a href="tender-edit.php?id=<?php echo $data['id']; ?>"><img src="images/edit.png" alt=""></a></td>
