...
<div class="heading">
<div class="heading-left">View Press Releases </div>
<div class="heading-right"><a href="press-add.php" class="button1">Add Releases </a></div>
<div class="clr"></div>
</div>
...
$sql= "SELECT * FROM  press ORDER BY id desc";
...
<?php } ?></td>
<td align="center"><a href="press-add.php?id=<?php echo urlencode(base64_encode($id)); ?>"><img src="images/edit.png" alt=""></a></td>
