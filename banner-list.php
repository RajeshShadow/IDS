...
<div class="heading">
<div class="heading-left">View Banner</div>
<div class="heading-right"><a href="banner-add.php" class="button1">Add Banner Images</a></div>
<div class="clr"></div>
</div>
...
<td><img src="upload_images/banner/<?php echo $data['img']; ?>" alt=""></td>
...
<?php } ?></td>
<td align="center"><a href="banner-edit.php?id=<?php echo urlencode(base64_encode($data['id'])); ?>"><img src="images/edit.png" alt=""></a></td>
...
<span>
<input type="submit" name="submit" value="Activate" onclick="return del_prompt(this.form,this.value)" required>
</span> <span>
<input type="submit" name="submit" value="Deactivate" onclick="return del_prompt(this.form,this.value)" required>
</span> <span>
<input type="submit" name="submit" value="Delete" onclick="return del_prompt(this.form,this.value)" required>
</span> </div>
</form>
</div>
<div class="clr"></div>
